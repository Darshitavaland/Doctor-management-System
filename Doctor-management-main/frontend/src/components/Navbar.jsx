...
function Navbar() {
    ...
    return (
        <div className='  flex items-center justify-between text-sm py-4 mb-5 border-b border-b-gray-400 ' >
            ...
            <ul className=' hide md:flex items-start gap-5 font-medium ' >
                <NavLink to='/'>
                    <li className='p-1' >HOME</li>
                    <hr className='border-none outline-none h-0.5 bg-primary w-3/5 m-auto hiden' />
                </NavLink >
                <NavLink to='/doctors'>
            ...
            <div className='flex items-center gap-4'>
                {
                    token && userData ? <div className='flex gap-2 cursor-pointer group relative'>
                    ...
                    : <button onClick={() => navigate('/login')} className='bg-primary text-white px-8 py-3 rounded-full font-light hide md:block' >Create Account</button>

...
function AddDoctor() {
  ...
  return (
    ...
    <form className='m-5 w-full' onSubmit={onSubmitHandle}>
      ...
      <div className='bg-white px-8 py-8 border rounded w-full max-w-4xl max-h-[80vh] overflow-y-scroll '>
          ...
          <div className='w-full lg:flex-1 flex flex-col gap-4'>
            <div className='flex-1 flex flex-col gap-1'>
              ...
              <select onChange={(e) => setSpeciality(e.target.value)} value={speciality} className='border rounded px-3 py-2' name="" id="">
                ...
                <option value="Neurologisst">Neurologisst</option>
        ...
        <div className='flex-1 flex flex-col gap-1'>
          ...
          <textarea onChange={(e) => setAbout(e.target.value)} value={about} className='w-full px-4 pt-2 border rounded ' type='text' name="" id="" placeholder='write about doctor' rows={5} required ></textarea>
        </div>
